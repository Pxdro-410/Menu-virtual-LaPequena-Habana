  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#000000] via-[#16204f] to-[#000000] text-white py-6 sm:py-10 md:py-14 px-4 sm:px-6 lg:px-8 border-b border-[#1c275c]">
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-1.5 md:gap-2 bg-[#d61327]/20 text-[#fca5a5] border border-[#d61327]/40 px-2.5 py-0.5 md:px-3.5 md:py-1 rounded-full text-[10px] md:text-xs font-semibold uppercase tracking-wider mb-2.5 md:mb-4">
          <span>De cuba para el mundo entero</span>
        </div>

        {/* Main Title (Desktop original text-5xl lg:text-6xl restored) */}
        ...
        {/* Subtitle (Desktop original text and font sizes restored) */}
        <p className="max-w-2xl mx-auto text-stone-100 text-xs sm:text-base lg:text-lg font-light leading-relaxed mb-3 md:mb-6">
